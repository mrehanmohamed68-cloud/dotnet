...
namespace day9_csharp
{
    internal class Program1
    {
        public static void RunOldDemo()
        {
            ...
            #region 16) Generic Reverse<T> (Problem 1)
            Console.WriteLine("---- 16) ArrayHelper.Reverse<T> ----");
            int[] intArr = { 1, 2, 3, 4, 5 };
            string[] strArr = { "a", "b", "c" };
            ScoreItem[] objArr =
            {
                new ScoreItem("Ali", 90),
                new ScoreItem("Sara", 85),
                new ScoreItem("Omar", 78)
            };

            Console.WriteLine("int:    " + string.Join(", ", ArrayHelper.Reverse(intArr)));
            Console.WriteLine("string: " + string.Join(", ", ArrayHelper.Reverse(strArr)));
            Console.WriteLine("object: " + string.Join(", ", ArrayHelper.Reverse(objArr)));
            #endregion

            Console.WriteLine();

            #region 17) GenericStack<T> (Problem 2)
            Console.WriteLine("---- 17) GenericStack<T> ----");
            ...
            Console.WriteLine($"Count after pops: {intStack.Count}"); // 1

            GenericStack<string> nameStack = new GenericStack<string>();
            nameStack.Push("First");
            nameStack.Push("Second");
            Console.WriteLine($"String stack Peek: {nameStack.Peek()}"); // Second
            #endregion

            Console.WriteLine();

            #region 18) Generic Swap<T> on array by index (Problem 3)
            Console.WriteLine("---- 18) ArrayHelper.Swap<T> ----");
            int[] swapArr = { 1, 2, 3, 4 };
            Console.WriteLine("Before: " + string.Join(", ", swapArr));
            ArrayHelper.Swap(swapArr, 0, 3);
            Console.WriteLine("After:  " + string.Join(", ", swapArr));
            #endregion

            Console.WriteLine();

            #region 19) Generic FindMax<T> (Problem 4)
            Console.WriteLine("---- 19) ArrayHelper.FindMax<T> ----");
            Console.WriteLine($"Max int:    {ArrayHelper.FindMax(intArr)}");
            Console.WriteLine($"Max string: {ArrayHelper.FindMax(strArr)}"); // lexicographic
            Console.WriteLine($"Max score:  {ArrayHelper.FindMax(objArr)}"); // uses ScoreItem.CompareTo
            #endregion
    ...
    // Small IComparable custom type used to prove Reverse<T>/FindMax<T> work
    // with user-defined objects, not just built-in types.
    public class ScoreItem : IComparable<ScoreItem>
    {
        ...
        public int CompareTo(ScoreItem other) => Score.CompareTo(other.Score);
